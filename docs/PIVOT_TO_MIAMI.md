# ⚠️ PROJECT PIVOT: Los Angeles → Miami / Florida (Vice City)

**Date:** 2026-06-11. **Decision by:** project owner.

The game is set in **Miami, Florida (Vice City)** — GTA VI's real setting — **not
...
- `game/assets/world/`: all LA district JSONs **deleted**; replaced with 5 real
  ...
  rebuilt.
- `game/scenes/world/miami.tscn`: **the new game map** (streamer + warm Vice City
...
- **Stop building LA.** Retire LA scenes: `los_angeles_streamed.tscn`,
  ...
  deleted data.
- **Build Miami districts.** More Vice City areas: Ocean Drive detail, Star Island,
