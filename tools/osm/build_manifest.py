#!/usr/bin/env python3
"""Rebuild the district manifest (game/assets/world/districts.json) from every
district JSON present, computing each district's offset from the shared world
origin. Run after fetching new districts so the streamer picks them up — adding
LA coverage becomes pure data, no code changes.
        ...
        districts.append(
            {
                ...
                "data": f"res://assets/world/{f.name}",
                "centroid": c,
