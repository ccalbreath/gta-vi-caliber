...
network + GIS work *once* and writes a compact JSON resource that the Godot
layer reads deterministically. Heights and road widths are resolved here from
OSM tags into plain numbers; projection to local meters happens in-engine
(scripts/world/geo_projection.gd) so it stays unit-testable.

Usage:
    tools/osm/fetch_district.py --name downtown_la \\
        --bbox 34.0470 -118.2570 34.0540 -118.2480

Output: game/assets/world/<name>.json   (OSM data © OpenStreetMap contributors, ODbL)
"""
